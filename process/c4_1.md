...
* The project SHALL use the [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0).
...
* Maintainers SHOULD NOT accept their own patches.
...
* [The original C4](http://rfc.zeromq.org/spec:22)

### bibliography

1. ["Key words for use in RFCs to Indicate Requirement Levels"](http://tools.ietf.org/html/rfc2119)
1. ["Definition of a Free and Open Standard"](http://www.digistan.org/open-standard:definition)
1. ["Consensus Oriented Specification System"](http://www.digistan.org/spec:1/COSS)
